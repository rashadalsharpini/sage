...
Thanks to Rocky Bernstein and Juan Mauricio Matera for their support. For further acknowledgments see `this list <https://github.com/mathics3/Mathics3/blob/master/AUTHORS.txt>`__.
